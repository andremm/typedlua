...
\frac{\env \vdash el:S \;\;\;
      ...
      \env[\vec{i} \mapsto \vec{t}] \vdash s}
...
\frac{\env \vdash f:S_{1} \rightarrow S_{2} \;\;\;
  \env[i \mapsto S_{1} \rightarrow S_{2}, \string_ret \mapsto S_{2}] \vdash s}
...
\[
\frac{\env[\string_ret \mapsto T_{r}] \vdash b}
...
\[
\frac{\env[\vec{i} \mapsto \vec{t}, \string_ret \mapsto T_{r}] \vdash b}
     {\kw{fun} (\overrightarrow{i:t}):t_{r} \; b :
      T_{1} \times ... \times T_{n} \rightarrow T_{r}}
\mylabel{T-FUNCTION3}
\]
...
\frac{\env[\vec{i} \mapsto \vec{t}, \string_ret \mapsto T_{r}] \vdash b}
     {\kw{fun} (\overrightarrow{i:t}, {...}:t):t_{r} \; b :
      T_{1} \times ... \times T_{n} \times {T*} \rightarrow T_{r}}
\mylabel{T-FUNCTION4}
\]
