...
\[
\frac{\senv \vdash T_{3} \subtype T_{1} \;\;\;
      \senv \vdash T_{2} \subtype T_{4} \;\;\;
      \senv \vdash T_{4} \subtype T_{2}}
     {\senv \vdash T_{1}:T_{2} \subtype T_{3}:T_{4}}
\mylabel{S-FIELD1}
\]
...
\frac{\senv \vdash T_{3} \subtype T_{1} \;\;\;
      \senv \vdash T_{2} \subtype T_{4}}
     {\senv \vdash \Const \; T_{1}:T_{2} \subtype T_{3}:T_{4}}
\mylabel{S-FIELD2}
\]
...
\frac{\senv \vdash T_{3} \subtype T_{1} \;\;\;
      \senv \vdash T_{2} \subtype T_{4}}
     {\senv \vdash T_{1}:T_{2} \subtype \Const \; T_{3}:T_{4}}
\mylabel{S-FIELD3}
\]
...
\frac{\senv \vdash T_{3} \subtype T_{1} \;\;\;
      \senv \vdash T_{2} \subtype T_{4}}
     {\senv \vdash \Const \; T_{1}:T_{2} \subtype \Const \; T_{3}:T_{4}}
\mylabel{S-FIELD4}
\]
...
\[
\frac{\env \vdash e_{1} : \{ T_{1}:T_{1}', ..., T_{n}:T_{n}' \} \;\;\;
      \env \vdash e_{2} : T \;\;\;
      \exists i \in 1..n \;
      T_{i} \subtype T \;\;\; T \subtype T_{i}}
