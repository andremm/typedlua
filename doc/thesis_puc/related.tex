...
Bierman and associates \cite{bierman2014typescript} shows how to
...
Politz and associates \cite{politz2012semantics} proposes semantics
...
Allende and associates \cite{allende2013cis} perform a careful
...
Homer and associates \cite{homer2013modules} explores some
