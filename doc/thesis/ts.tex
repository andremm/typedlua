...
& | \; \{k_{i}{:}v_{i}, ..., k_{n}{:}v_{n}\}_{c|o|u} & \textit{table types}\\
...
\dfrac{\forall i \in 1..n \; \exists j \in 1..m \;\;\;
      ...
      {\senv \vdash \{k_{1}{:}v_{1}, ..., k_{m}{:}v_{m}\} \subtype \{k_{1}{:}v_{1}, ..., k_{n}{:}v_{n}\}}
\]
...
\dfrac{closeall(\env_{1}[\ret \mapsto r]) \vdash s:\env_{2}}
      {\env_{1} \vdash \mathbf{fun} \; (){:}r \; s:\Void \rightarrow r, closeset(\env_{1}, fav(s))}
\]

\mylabel{T-FUNCTION2}
\[
\dfrac{closeall(\env_{1}[{...} \mapsto t, \ret \mapsto r]) \vdash s:\env_{2}}
      {\env_{1} \vdash \mathbf{fun} \; ({...}{:}t){:}r \; s:t{*} \rightarrow r, closeset(\env_{1}, fav(s))}
\]

\mylabel{T-FUNCTION3}
\[
\dfrac{closeall(\env_{1}[\vec{n} \mapsto \vec{t}, \ret \mapsto r]) \vdash s:\env_{2}}
      {\env_{1} \vdash \mathbf{fun} \; (\vec{n{:}t}){:}r \; s:\vec{t} \rightarrow r, closeset(\env_{1}, fav(s))}
\]

\mylabel{T-FUNCTION4}
\[
\dfrac{closeall(\env_{1}[\vec{n} \mapsto \vec{t}, {...} \mapsto t, \ret \mapsto r]) \vdash s:\env_{2}}
      {\env_{1} \vdash \mathbf{fun} \; (\vec{n{:}t},{...}{:}t){:}r \; s: \vec{t} \times t{*} \rightarrow r, closeset(\env_{1}, fav(s))}
\]
...
\dfrac{\env_{1} \vdash e:p_{1} \rightarrow r, \env_{2} \;\;\;
       \env_{2} \vdash el:p_{2}, \env_{3} \;\;\;
       p_{2} \lesssim p_{1}}
      {\env_{1} \vdash e(el):first(r), \env_{3}}
\]
...
\dfrac{\env_{1} \vdash e[n]:p_{1} \rightarrow r, \env_{2} \;\;\;
       \env_{2} \vdash el:p_{2}, \env_{3} \;\;\;
       p_{2} \lesssim p_{1}}
      {\env_{1} \vdash e{:}n(el):first(r), \env_{3}}
\]
...
\mylabel{T-EXPLIST1}
\[
\env \vdash \mathbf{nothing}:\Nil{*}, \env_{1}
\]

\mylabel{T-EXPLIST2}
\[
\dfrac{\env \vdash e_{1}:t_{1}, \env_{1}, ..., \env \vdash e_{n}:t_{n}, \env_{n}}
...
\mylabel{T-EXPLIST4}
\[
\dfrac{\env \vdash e_{1}:t_{1}, \env_{1}, ..., \env \vdash e_{n}:t_{n}, \env_{n}, \env \vdash me:r, \env_{n+1}}
      {\env \vdash \vec{e},me:t_{1} \times ... \times t_{n} \times r, merge(\env_{1}, ..., \env_{n+1})}
\]

\subsection{Constructor list}
