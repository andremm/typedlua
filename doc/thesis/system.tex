...
These rules state the conditions when variadic tuples of different
...
For instance, the rules \textsc{T-EXPLIST2} and \textsc{T-EXPLIST3} handle
the case where an expression list ends with an expression that may produce
multiple values.
