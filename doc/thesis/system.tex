...
\mylabel{T-IDREAD}\\
\dfrac{\env_{1}(n) = t}
      {\env_{1} \vdash n_{e}:close(t), \env_{1}[n \mapsto open(t)]}
\end{array}
\]
...
\mylabel{T-IDWRITE}\\
\dfrac{\env_{1}(n) = t}
      {\env_{1} \vdash n_{l}:close(t), \env_{1}[n \mapsto close(t)]}
\end{array}
\]
...
\dfrac{\env_{1}(n) = \{k_{1}{:}v_{1}, ..., k_{n}{:}v_{n}\} \;\;\;
      ...
      {\env_{1} \vdash n[e_{2}]:v_{i}, \env_{2}}
\end{array}
\\ \\
\begin{array}{c}
\mylabel{T-INDEX2}\\
...
\dfrac{\env_{1}(n) \subtype t \;\;\;
       \env_{1}[n \mapsto t] \vdash n_{e}:t_{1}, \env_{2}}
      {\env_{1} \vdash {<}t{>} \; n:t_{1}, \env_{2}}
\end{array}
\]
