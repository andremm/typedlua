...
Overloading on the input parameter.
\begin{center}
\begin{tabular}{llll}
...
& & \multicolumn{2}{l}{$\mathbf{if} \; type(b) == ``string" \; \mathbf{then}$}\\
& & & \multicolumn{1}{l}{$\mathbf{return} \; a \; {..} \; b$}\\
& & \multicolumn{2}{l}{$\mathbf{else}$}\\
& & & \multicolumn{1}{l}{$\mathbf{return} \; rep(a, b)_{e}$}\\
...
\begin{center}
\begin{tabular}{lll}
\multicolumn{3}{l}{$\mathbf{local} \; q:\pi_{1}, r:\pi_{2} = idiv(1, 2) \; \mathbf{in}$}\\
& \multicolumn{2}{l}{$\mathbf{if} \; type(r) == ``string" \; \mathbf{then}$}\\
& & \multicolumn{1}{l}{$print(``ERROR: " \; .. \; r)_{s}$}\\
& \multicolumn{2}{l}{$\mathbf{else}$}\\
& & \multicolumn{1}{l}{$print(q + r)_{s}$}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ll}
\multicolumn{2}{l}{$\mathbf{local} \; t:\{\String:\Integer \cup \Nil\}_{closed} = \{ [``foo"] = 1 \} \; \mathbf{in}$}\\
& \multicolumn{1}{l}{$\mathbf{local} \; x:\Integer \cup \Nil = t[``foo"] \; \mathbf{in} \; x = t[``bar"]$}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ll}
\multicolumn{2}{l}{$\mathbf{local} \; t:\{\Integer:\String \cup \Nil\}_{closed} = \{ ``a", ``b", ``c" \} \; \mathbf{in}$}\\
& \multicolumn{1}{l}{$\mathbf{local} \; x:\String \cup \Nil = t[1] \; \mathbf{in} \; x = t[4]$}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ll}
\multicolumn{2}{l}{$\mathbf{local} \; t:\{``f":\String, ``l":\String\}_{closed} =$}\\
& \multicolumn{1}{l}{$\{ [``l"] = ``Reed", [``f"] = ``Lou" \}$}\\
...
\begin{center}
\begin{tabular}{ll}
\multicolumn{2}{l}{$\mathbf{local} \; t:\{``f":\String, ``m":\String \cup \Nil, ``l":\String\}_{closed} =$}\\
& \multicolumn{1}{l}{$\{ [``f"] = ``Lewis", [``m"] = ``Allan", [``l"] = ``Reed" \}$}\\
\multicolumn{2}{l}{$\mathbf{in} \; \mathbf{skip}$}
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ll}
\multicolumn{2}{l}{$\mathbf{local} \; t:\{\}_{open} = \{\} \; \mathbf{in}$}\\
& \multicolumn{1}{l}{$t[``f"] \; {<}\String{>} = ``Lou";$}\\
& \multicolumn{1}{l}{$t[``l"] \; {<}\String{>} = ``Reed";$}\\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{lll}
\multicolumn{3}{l}{$\mathbf{local} \; t:\{\}_{open} = \{\} \; \mathbf{in}$}\\
& \multicolumn{2}{l}{$\mathbf{local} \; b:\{\}_{open} = p \; \mathbf{in}$}\\
& & \multicolumn{1}{l}{$t[``f"] \; {<}\String{>} = ``Lou";$}\\
& & \multicolumn{1}{l}{$t[``l"] \; {<}\String{>} = ``Reed";$}\\
\end{tabular}
\end{center}
