...
Note that the coercion rules only allows changing the type
...
More precisely, the former function filters out the tuples that contain a type $\Nil$ in the $i$-th component,
...
As an example, our previous example type checks through rule \textsc{T-IF5},
