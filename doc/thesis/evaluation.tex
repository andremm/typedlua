...
This case study shows that type annotations are a good source of documentation,
tough it might be not so obious to identify which functions discard extra
parameters when we are typing an external library.
