...
In this section we compare Typed Lua with other projects and type systems.
...
other type systems that are not related to Lua.
...
of a table type.
The field types describe if a table field is mutable or imutable
in a table type.
