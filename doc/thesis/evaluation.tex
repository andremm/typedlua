...
\hline
Lua 5.2 Standard Library & 94 & 5 & 34 & 133 & 71\% \\
\hline
Lua 5.3 Standard Library & 87 & 6 & 36 & 129 & 67\% \\
\hline
MD5 & 13 & 0 & 0 & 13 & 100\% \\
\hline
...
We split the members of each case study into three categories:
...
The \emph{hard} category represents the members that either we
had to rely on the dynamic type to type them or we used a static
type that is not precise enough;
...
\hline
\multirow{9}{*}{Lua Standard Library}
& base & 9 & 1 & 16 & 26 & 35\% \\
\cline{2-7}
& coroutine & 0 & 0 & 6 & 6 & 0\% \\
\cline{2-7}
...
\end{tabular}
\end{center}
\caption{Evaluation results for Lua 5.2 Standard Library}
\label{tab:evallsl}
\end{table}
...
\end{tabular}
\end{center}
\caption{Evaluation results for Lua 5.3 Standard Library}
\label{tab:evallsl53}
\end{table}
