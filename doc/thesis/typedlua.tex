...
Section \ref{sec:tables}, respectivelly.
...
recursive local functions to inform the type cheker what type
...
Next we show how we can apply this alteranative solution to the
...
while aliasing \emph{unique} table types, like in the follwoing
example:
\begin{verbatim}
    local t1 = { x = 1 }
