...
Even though Typed Lua includes two different forms for annotating
...
A return statement that appears in the top-level also exports
...
Note that this class definition introduces a syntactical overhead
