...
The table constructor describes \emph{unique} table types,
as they are tables that we know all the fields and that there is
no alias to it.
...
\emph{open} tables:
the table must assigned to a local variable to the current block,
