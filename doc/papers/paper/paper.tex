...
\mylabel{T-IdReadFix}\\
\dfrac{\env(id) = F}
{\env, \penv \vdash id:fix(F), \env[id \mapsto fix(F)]}
\end{array}
\end{array}
\]
...
\begin{figure*}
	...
	wf(\mu x.F) & = & wf(F) \\
	wf({\bf const}\; F) & = & wf(F) \\
	wf(\phi(F_1,F_2)) & = & wf(F_1)\,\wedge\,wf(F_2)\\
	wf(S_1 \sqcup S_2) & = & wf(S_1) \,\wedge\, S_2\\
	wf(F{*}) &=& wf(F) \\
	wf(T \times P) &=& wf(T) \,\wedge\,wf(P)\\
	wf(T) & = & \top \;\;\;\mathrm{for\; all\; other\; cases}\\\\
	tag(F_1 \cup F_2, t) & = & tag(F_1, t) \,\vee\, tag(F_2,t) \\
	tag(\{\overline{K:V}\}_t, t) & = & \top\\
	\multicolumn{3}{c}{
		\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\mathrm{other\;recusive\;cases\;are\;similar}}\\
	\multicolumn{3}{c}{\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\;\mathrm{other\;base\;cases\;are\;}\bot}\\\\
...
tables in one enviroment but not the other. Two environments
...
Rule {\sc T-Id} is responsible for tracking
