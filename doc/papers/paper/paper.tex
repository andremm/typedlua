...
Table types represent the various forms
...
A variadic type $T{*}$ represents an unbounded sequence of values of type $T \cup \Nil$.
...
A projection type in l-value position does not trigger
the projection, effectively forbidding assignment to a
variable that has a projection type. Allowing assignment
