...
This migration from dynamic to static usually involves
different languages, which distinct syntax and semantics,
...
presents the methodology and results of our survey of Lua
idioms; Section 3 presents the types of Typed Lua's
type system, and their subtyping and consistent-subtyping
relationd; Section 4 presents the typing rules for
evolution of table types; Section 5 presents the typing rules
for destructuring unions of tuples into projection types
and flow typing on these projections; Section 6 reviews
related work; Section 7 presents our conclusions, and
