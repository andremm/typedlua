...
\subsubsection{Assignment and function application}
...
\dfrac{\begin{array}{c}
       ...
       \env_{1}, \penv \vdash me:T_{n+1} \times ... \times \Void, \env_{n+2} \\
       n = |\;\overline{e}\;| \;\;\;
       \env_{m} = merge(\env_{1}, ..., \env_{n+2})
       \end{array}}
      {\env_{1}, \penv \vdash \overline{e},me:T_{1} \times ... \times T_{n+1} \times ... \times \Nil{*}, \env_{m}}
\end{array}
\\ \\
\begin{array}{c}
\mylabel{T-EXPLIST3}\\
\dfrac{\begin{array}{c}
       \env_{1}, \penv \vdash e_{i}:T_{i}, \env_{i+1} \\
       \env_{1}, \penv \vdash me:T_{n+1} \times ... \times T{*}, \env_{n+2} \\
       n = |\;\overline{e}\;| \;\;\;
       \env_{m} = merge(\env_{1}, ..., \env_{n+2})
       \end{array}}
      {\env_{1}, \penv \vdash \overline{e},me:T_{1} \times ... \times T_{n+1} \times ... \times T{*}, \env_{m}}
\end{array}
\end{array}
\]
...
In the case of \texttt{math.random}, it also has two different types:
